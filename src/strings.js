const STRINGS = {
  en: {
    ...
    'house.title': 'A house',
    'house.startHint': 'A bell lives here. Leave by the door you came in through.',
  ...
  'pt-br': {
    ...
    'house.title': 'Uma casa',
    'house.startHint': 'Um sino mora aqui. Saia pela porta por onde entrou.',
